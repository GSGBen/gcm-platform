...
metadata description = 'ALZ Bicep Module to set up Management Group structure. Modified from source to remove telemetry.'
metadata source = 'https://github.com/Azure/ALZ-Bicep/blob/main/infra-as-code/bicep/modules/managementGroups/managementGroups.bicep'
